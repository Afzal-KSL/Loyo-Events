        ...
        <div class = "content"><!--body content holder-->
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            <h1 style="color:#003300 ; font-size:38px ;" ><u><strong>TECH FREAKS</strong></u></h1><!--title-->
                            <p><!--content-->
                                EMBRACE YOUR TECHNOLOGY SKILLS BY PARTICIPATING IN OUR DIFFERENT TECH EVENTS!
                            </p>
                            
                            <br><br>
                        <?php $id=1;
                        echo
                            "<h3><strong>Type ID: $id</strong></h3>";
                        echo
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="col-md-6"><!--image holder with 6 grid columns-->
                            <img src="images/sports1.jpg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            <h1 style="color:#003300 ; font-size:38px ;"><strong><u>LOYO SPORTS</u></strong></h1><!--title-->
                            <p><!--content-->
                                EMBRACE YOUR SPORTS LOVE BY PARTICIPATING IN OUR DIFFERENT SPORTS EVENTS!
                            </p>
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="col-md-6"><!--image holder with 6 grid columns-->
                            <img src="images/loyoonstage.jpg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        <div class="col-md-6"><!--image holder with 6 grid columns-->
                            <img src="images/loyooffstage.jpg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
