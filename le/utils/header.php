...
<style>
.bgImage {
    background-image: url(images/Loyoevent.jpg);
    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1><strong>Let's Explore The Events<br></strong>Of Our College</h1><!--jumbotron heading-->
                <p style="font-style: bold">"Once a Loyolite, Always a Loyolite"</p>
                <br>
